...
class Category(models.Model):
    ...
    slug=models.SlugField(_("سيوی  سایت"))
    publish_at=models.DateTimeField(_("انتشار"), auto_now=False, auto_now_add=False)
...
class Comments(models.Model):
    blog=models.ForeignKey(Blog,related_name='comments',verbose_name=" مقاله مربوطه ",on_delete=models.CASCADE)
    ...
    date=models.DateField(_("تاریخ انتشار"), auto_now=True, auto_now_add=False,blank=True,null=True)
